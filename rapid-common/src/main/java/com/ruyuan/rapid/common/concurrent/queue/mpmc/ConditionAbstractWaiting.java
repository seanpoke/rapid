...
public abstract class ConditionAbstractWaiting implements Condition {
    ...
    private final AtomicReferenceArray<Thread> waiter = 
    		new AtomicReferenceArray<>(MAX_WAITERS+2*CACHE_LINE_REFS);
        ...
        for (;;) {
            ...
            try {
                ...
                if(waitCount == 0) {
                    ...
                    while(test() && 
                    		(waiter.get((int)((waitSequence-1) & WAITER_MASK)+CACHE_LINE_REFS) == t) &&
                    ...
                    if(t.isInterrupted()) {
                        ...
                        while(!waiter.compareAndSet((int)((waitSequence-1) & WAITER_MASK)+CACHE_LINE_REFS, t, null) && 
                        		waiter.get(CACHE_LINE_REFS) == t) {
